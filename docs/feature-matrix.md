...
| --- | --- | --- | --- |
| 首页推荐 / 分页 | `Features/Home`、`Core/Network/TiebaAPI.swift` | 已有首版，需真实接口联调 | 空页、分页、屏蔽后继续加载 |
...
| 帖子详情 / 楼中楼 | `Features/Thread` | 已有首版，需媒体和分页验收 | 阅读位置、回复分页、横竖屏 |
| 全局 / 吧内搜索 | `Features/Search`、`Core/Network/TiebaSearchAPI.swift` | 请求策略已接入，需接口联调 | iOS 14 页面内搜索、历史、用户/贴吧/帖子跳转 |
...
| 图片 / 视频 / 语音 | `Features/Media`、`Features/Voice` | 已有首版，需设备验收 | 缓存上限、蜂窝网络提示、分享/保存 |
